...
export const IconApple = React.forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => (
  <svg
  ...
  >
    <g clipPath="url(#clip0_3297_18582)">
      ...
      <g mask="url(#mask0_3297_18582)">
        ...
        <path d="M16.2001 1C16.3001 2.4 15.9001 3.6 15.0001 4.6C14.6001 5.1 14.1001 5.5 13.5001 5.8C13.0001 6 12.5001 6.1 11.9001 6C11.9001 5.3 11.9001 4.6 12.2001 4C12.9001 2.4 14.1001 1.4 15.8001 1H16.1001H16.2001Z" fill="currentColor"/>
      </g>
    </g>
    <defs>
